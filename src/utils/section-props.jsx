...
export const proofreadingProps = {
	...
	titleJapanese: `英文校正`,
	contentJapanese: `<p>主に、船舶・エネルギー・環境・教育や学術の領域における政府関連文書、ホームページや技術的なガイドブックの翻訳を手掛けるなか、翻訳された文書は、スペルミスや文法のエラー、不自然な単語の繰り返しや不整合など細心の注意を払って、校正致しております。また、英文校正のみのサービスもございます。お見積もりやご納期のご相談をお聞かせください。ご依頼の文書が複数の図表やチャートの体裁も含まれる場合も、お気軽にお問い合わせいただけますと幸いです。YUZENへのご用命は、ご依頼の文書を添付のうえ contact@yuzentranslation.comへご送信願います。受領に就きましては、遅くても通常営業2日以内にご連絡差し上げます。どうぞ宜しくお願い申し上げます。</p>`,
	isJapanese: false,
}
...
export const presentationProps = {
	...
	contentJapanese: `<p>手ごたえの得られそうな御社の顧客様にプロフェッショナルなプレゼンを行う際、 明確で説得力のある方法で意思を伝えることが重要になります。セッションの終わりに、聴き手が家に持ち帰りたくなるような製品づくりは、そのプレゼンに掛かっています。 当社の経験豊富なプレゼンのコーチは、貴社の味方です。自信のあるプロフェッショナルなプレゼンを聴き手に印象付けるように、段階を踏んでサポートします。 効果的なプレゼンテーションの定義から個別の弱点克服までをサポート。論理的思考、ボディーランゲージ、イントネーション、タイミングの取り方等、メッセージを確実に聴き手に届けるスキルのお役立ちをいたします。弊社の翻訳や英文校正のサービスを合わせた、プレゼンコーチサービスも提供致しております。 また、国際的なシンポジウムを控えていらっしゃる際も、お気軽にご用命いただけますと幸いです。</p>`,
	isJapanese: false,
}
